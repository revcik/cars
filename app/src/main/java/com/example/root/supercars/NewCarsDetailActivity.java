...
public class NewCarsDetailActivity extends Activity {
    ...
    public void selectcar(String brand){
        ...
        Cursor cursor = db.query("NEWCARS", new String[]{"YEAR", "BRAND", "MODEL", "CAR_IMAGE", "ENGINE", "WEIGHT", "BHP", "ACCEL", "SPEED", "PRICE", "DESCRIPTION"},"BRAND = ?", new String[]{brand}, null, null, null);
        cursor.moveToFirst();
